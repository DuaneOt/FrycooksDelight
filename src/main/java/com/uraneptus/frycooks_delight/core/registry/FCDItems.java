...
public class FCDItems {
    ...
    public static final RegistryObject<Item> FRIED_ONION_RING = ITEMS.register("fried_onion_ring", () -> new Item(FCDProperties.FRIED_ONION_RING));
    public static final RegistryObject<Item> FRIED_CHICKEN_LEG = ITEMS.register("fried_chicken_leg", () -> new Item(FCDProperties.FRIED_CHICKEN_LEG));
    public static final RegistryObject<Item> FRIED_FISH_SLICE = ITEMS.register("fried_fish_slice", () -> new Item(FCDProperties.FRIED_FISH_SLICE));
